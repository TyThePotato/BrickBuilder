...
public class AvatarImporter : MonoBehaviour
{
    ...
    public void BuildAvatar (AvatarRoot avatar, Vector3 position, bool tool) {
        ...
        avatarHead.Scale = new Vector3(1.125f,1.125f,1.25f);
        avatarHead.Position = new Vector3(0.5f,-0.06f,3.7f) + position;
        Debug.Log(avatar);
        ...
        avatarTorso.Scale = new Vector3(2,1,2);
        avatarTorso.Position = new Vector3(0,0,2) + position;
        ...
        avatarLeftArm.Position = new Vector3(-1,0,2) + position;
        ...
        if (tool) {
            ...
            avatarRightArm.Position = new Vector3(2,-1,3) + position;
        } else {
            avatarRightArm.Scale = new Vector3(1,1,2);
            avatarRightArm.Position = new Vector3(2,0,2) + position;
        }
        ...
        avatarLeftLeg.Scale = new Vector3(1,1,2);
        avatarLeftLeg.Position = new Vector3(0,0,0) + position;
        ...
        avatarRightLeg.Scale = new Vector3(1,1,2);
        avatarRightLeg.Position = new Vector3(1,0,0) + position;
        ...
        for (int i = 0; i < avatar.items.hats.Length; i++) {
            ...
            if (hatId != 0) {
                ...
                hat.Position = new Vector3(0.5f, 0, 4.5f) + position;
        ...
        if (tool && avatar.items.tool != 0) {
            ...
            toolBrick.Position = new Vector3(3.5f, 0, 4.5f) + position;
